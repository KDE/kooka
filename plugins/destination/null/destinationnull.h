...
#ifndef DESTINATIONNULL_H
#define DESTINATIONNULL_H

#include "abstractdestination.h"


class DestinationNull : public AbstractDestination
{
    Q_OBJECT

public:
    explicit DestinationNull(QObject *pnt, const QVariantList &args);
    ~DestinationNull() override = default;
